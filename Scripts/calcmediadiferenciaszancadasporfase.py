...
# Función para calcular la media de las diferencias entre las duraciones de las fases
def calcular_media_diferencias(dominancia_duraciones, metodo_duraciones):
    ...
    # Calcular las diferencias entre las duraciones de las fases
...
if __name__ == "__main__":
    ...
    # Calcular la media de las diferencias para cada fase
    media_lr_csv = calcular_media_diferencias(duraciones_dominancia_lr, duraciones_metodo_csv_lr)
    media_lr_video = calcular_media_diferencias(duraciones_dominancia_lr, duraciones_metodo_video_lr)

    media_mst_csv = calcular_media_diferencias(duraciones_dominancia_mst, duraciones_metodo_csv_mst)
    media_mst_video = calcular_media_diferencias(duraciones_dominancia_mst, duraciones_metodo_video_mst)

    media_tst_csv = calcular_media_diferencias(duraciones_dominancia_tst, duraciones_metodo_csv_tst)
    media_tst_video = calcular_media_diferencias(duraciones_dominancia_tst, duraciones_metodo_video_tst)

    media_psw_csv = calcular_media_diferencias(duraciones_dominancia_psw, duraciones_metodo_csv_psw)
    media_psw_video = calcular_media_diferencias(duraciones_dominancia_psw, duraciones_metodo_video_psw)

    media_sw_csv = calcular_media_diferencias(duraciones_dominancia_sw, duraciones_metodo_csv_sw)
    media_sw_video = calcular_media_diferencias(duraciones_dominancia_sw, duraciones_metodo_video_sw)

    # Crear DataFrame con los resultados
    resultados = pd.DataFrame({
        "Fase": ["LR", "MSt", "TSt", "PSw", "Sw"],
        "Media de Diferencia por Zancada (dominancia vs CSV)": [media_lr_csv, media_mst_csv, media_tst_csv, media_psw_csv, media_sw_csv],
        "Media de Diferencia por Zancada (dominancia vs Video)": [media_lr_video, media_mst_video, media_tst_video, media_psw_video, media_sw_video],
    })
    ...
    print(f"Medias de las diferencias calculadas y guardadas en: {archivo_guardado}")
